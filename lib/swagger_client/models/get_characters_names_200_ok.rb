...
module SwaggerClient
  ...
  class GetCharactersNames200Ok
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'character_name')
        self.character_name = attributes[:'character_name']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @character_name.nil?
        invalid_properties.push('invalid value for "character_name", character_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @character_name.nil?
      true
    end
    ...
    def hash
      [character_id, character_name].hash
    end
