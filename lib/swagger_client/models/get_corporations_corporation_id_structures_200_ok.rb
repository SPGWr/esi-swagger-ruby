...
module SwaggerClient
  ...
  class GetCorporationsCorporationIdStructures200Ok
    ...
    def list_invalid_properties
      ...
      if @reinforce_weekday.nil?
        invalid_properties.push('invalid value for "reinforce_weekday", reinforce_weekday cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reinforce_weekday.nil?
      return false if @reinforce_weekday > 6
      return false if @reinforce_weekday < 0
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ['anchor_vulnerable', 'anchoring', 'armor_reinforce', 'armor_vulnerable', 'fitting_invulnerable', 'hull_reinforce', 'hull_vulnerable', 'online_deprecated', 'onlining_vulnerable', 'shield_vulnerable', 'unanchored', 'unknown'])
    ...
    def reinforce_weekday=(reinforce_weekday)
      if reinforce_weekday.nil?
        fail ArgumentError, 'reinforce_weekday cannot be nil'
      end
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['anchor_vulnerable', 'anchoring', 'armor_reinforce', 'armor_vulnerable', 'fitting_invulnerable', 'hull_reinforce', 'hull_vulnerable', 'online_deprecated', 'onlining_vulnerable', 'shield_vulnerable', 'unanchored', 'unknown'])
