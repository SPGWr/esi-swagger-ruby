...
module SwaggerClient
  ...
  class GetUniverseSystemsSystemIdOk
    ...
    def list_invalid_properties
      ...
      if @planets.nil?
        invalid_properties.push('invalid value for "planets", planets cannot be nil.')
      end
      ...
      if @star_id.nil?
        invalid_properties.push('invalid value for "star_id", star_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @planets.nil?
      return false if @position.nil?
      return false if @security_status.nil?
      return false if @star_id.nil?
