...
module SwaggerClient
  ...
  class GetCorporationsCorporationIdOrdersHistory200Ok
    ...
    def hash
      [duration, escrow, is_buy_order, issued, location_id, min_volume, order_id, price, range, region_id, state, type_id, volume_remain, volume_total, wallet_division].hash
    end
