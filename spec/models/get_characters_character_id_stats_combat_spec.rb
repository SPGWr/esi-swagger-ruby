...
# Unit tests for SwaggerClient::GetCharactersCharacterIdStatsCombat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdStatsCombat' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCharactersCharacterIdStatsCombat.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdStatsCombat' do
    it 'should create an instance of GetCharactersCharacterIdStatsCombat' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCharactersCharacterIdStatsCombat)
    end
  end
