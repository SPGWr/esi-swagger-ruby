...
# Unit tests for SwaggerClient::GetSovereigntyCampaignsParticipant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSovereigntyCampaignsParticipant' do
  before do
    # run before each test
    @instance = SwaggerClient::GetSovereigntyCampaignsParticipant.new
  end
  ...
  describe 'test an instance of GetSovereigntyCampaignsParticipant' do
    it 'should create an instance of GetSovereigntyCampaignsParticipant' do
      expect(@instance).to be_instance_of(SwaggerClient::GetSovereigntyCampaignsParticipant)
    end
  end
