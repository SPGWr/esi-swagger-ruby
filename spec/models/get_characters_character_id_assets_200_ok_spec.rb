...
# Unit tests for SwaggerClient::GetCharactersCharacterIdAssets200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdAssets200Ok' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCharactersCharacterIdAssets200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdAssets200Ok' do
    it 'should create an instance of GetCharactersCharacterIdAssets200Ok' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCharactersCharacterIdAssets200Ok)
    end
  end
