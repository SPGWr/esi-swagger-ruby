...
# Unit tests for SwaggerClient::GetCharactersCharacterIdMailLabelsLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdMailLabelsLabel' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCharactersCharacterIdMailLabelsLabel.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdMailLabelsLabel' do
    it 'should create an instance of GetCharactersCharacterIdMailLabelsLabel' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCharactersCharacterIdMailLabelsLabel)
    end
  end
