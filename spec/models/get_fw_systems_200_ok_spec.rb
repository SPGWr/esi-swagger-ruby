...
# Unit tests for SwaggerClient::GetFwSystems200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwSystems200Ok' do
  before do
    # run before each test
    @instance = SwaggerClient::GetFwSystems200Ok.new
  end
  ...
  describe 'test an instance of GetFwSystems200Ok' do
    it 'should create an instance of GetFwSystems200Ok' do
      expect(@instance).to be_instance_of(SwaggerClient::GetFwSystems200Ok)
    end
  end
