...
# Unit tests for SwaggerClient::GetUniverseTypesTypeIdDogmaEffect
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseTypesTypeIdDogmaEffect' do
  before do
    # run before each test
    @instance = SwaggerClient::GetUniverseTypesTypeIdDogmaEffect.new
  end
  ...
  describe 'test an instance of GetUniverseTypesTypeIdDogmaEffect' do
    it 'should create an instance of GetUniverseTypesTypeIdDogmaEffect' do
      expect(@instance).to be_instance_of(SwaggerClient::GetUniverseTypesTypeIdDogmaEffect)
    end
  end
