...
# Unit tests for SwaggerClient::UserInterfaceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserInterfaceApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UserInterfaceApi.new
  end
  ...
  describe 'test an instance of UserInterfaceApi' do
    it 'should create an instance of UserInterfaceApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UserInterfaceApi)
    end
  end
