...
describe 'CorporationApi' do
  ...
  # unit tests for get_corporations_corporation_id_outposts
  ...
  # @option opts [String] :token Access token to use if unable to set a header
  # @return [Array<Integer>]
  describe 'get_corporations_corporation_id_outposts test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_corporations_corporation_id_outposts_outpost_id
  ...
  describe 'get_corporations_corporation_id_outposts_outpost_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
